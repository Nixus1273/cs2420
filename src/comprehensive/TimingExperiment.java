...
public abstract class TimingExperiment {
     ...
     */
    protected long computeMedianElapsedTime(int problemSize) throws IOException {
     ...
     */
    protected long computeElapsedTime(int problemSize) throws IOException{
     ...
     * @param problemSize - the problem size for one experiment
     */
    protected abstract void setupExperiment(int problemSize) throws IOException;

    /**
     * Abstract method to run the computation to be timed.
     */
    protected abstract void runComputation() throws IOException;
}
